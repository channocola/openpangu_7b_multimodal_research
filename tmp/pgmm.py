...
from multimodel.lavis.lavis.models.blip2_models.blip2 import Blip2Base, disabled_train
...
from PGN.multimodel.multimodel import Blip2QformerForPanGuMM
from multimodel.projector import build_vision_projector

from pgmmconfig import PGNMultiModalConfig, VisionProjectorConfig
...
class Blip2PanGu(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_pangu": "WorkSpace\WorkSpace\PGN\multimodel\lavis\lavis\configs\models\blip2\blip2_pretrain_openpangu7b.yaml", 
    }
    ...
    def __init__(
        ...
        self.vision_frontend = Blip2QformerForPanGuMM( 
            ...
            embed_dim=256, 
            max_txt_len=mm_config.max_txt_len,
        )
        if device is not None:
